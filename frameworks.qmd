...
A deep learning framework is a **library**, a collection of tools, to help build deep learning solutions. It gives access to multiple snippets of code to easyli implement building blocs of deep-learning. Por example, to implement a back-propagation with pytorch .....

![](images/papers-w-code_trends.png)

According to [Papers With Code](https://paperswithcode.com/trends) at the end of 2024 a vast majority, $60%$, of deep learning implementation uses PyTorch.

## What is it [PyTorch](pytorch.qmd)

[PyTorch](https://pytorch.org/) is Facebook AI Research Lab’s answer to [Google TensorFlow](https://www.tensorflow.org/). It is an open source, general-purpose library for machine learning and data science, specifically deep learning.
